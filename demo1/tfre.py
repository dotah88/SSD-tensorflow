...
VOC_LABELS = {
    ...
    'cyclist': (3, 'Vehicle'),
    'truck': (4, 'Vehicle'),
    'motorcyclist': (5, 'Vehicle'),
    'tricyclelist': (6, 'Vehicle'),
    'barrowlist': (7, 'Vehicle'),
    'van': (8, 'Vehicle'),
    'trafficcone': (9, 'Trafic'),
    'bus': (10, 'Vehicle'),
}

# 图片和标签存放的文件夹.
DIRECTORY_ANNOTATIONS = '/home/mt/learn/SSD-Tensorflow-master/demo1/train/images/'
DIRECTORY_IMAGES = '/home/mt/learn/SSD-Tensorflow-master/demo1/train/xml/'
...
dataset_dir = "/home/mt/learn/SSD-Tensorflow-master/VOCdevkit/VOC2007/"
output_dir = "/home/mt/learn/SSD-Tensorflow-master/tfrecords__"
name = "voc_train"
