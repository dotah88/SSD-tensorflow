...
for img in img_names:
    ...
    for img_each_label in gt:
        ...
        xml_file.write('            <xmin>' + str(spt[4].split('.')[0]) + '</xmin>\n')
        xml_file.write('            <ymin>' + str(spt[5].split('.')[0]) + '</ymin>\n')
        xml_file.write('            <xmax>' + str(spt[6].split('.')[0]) + '</xmax>\n')
        xml_file.write('            <ymax>' + str(spt[7].split('.')[0]) + '</ymax>\n')
        xml_file.write('        </bndbox>\n')
        xml_file.write('    </object>\n')
    xml_file.write('</annotation>')
